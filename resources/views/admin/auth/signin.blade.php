...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
  <head>
    ...
    <meta content="Grace African Christian Connections" name="description" />
  ...
  <body>
    <!-- auth-page wrapper -->
    <div style="background-image: url({{ asset('images/img/chbg.jpeg') }}); " class="auth-page-wrapper auth-bg-cover py-5 d-flex justify-content-center align-items-center min-vh-100">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card overflow-hidden">
                <div class="row g-0">
                  <div class="col-lg-6">
                    <div style="background-image: url({{ asset('images/img/img1.jpeg') }}); " class="p-lg-5 p-4 auth-one-bg h-100">
            ...
            <div class="col-lg-12">
              <div class="text-center">
                <p class="mb-0">&copy; <script>
                  ...
                  </script>  © GACC. Design & Develop by <a href="https://www.chamnet.co.tz/">chamnet </a></p>
              </div>
            </div>
          </div>
        </div>
